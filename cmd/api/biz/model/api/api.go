...
type Video struct {
	...
	Introduction string `thrift:"introduction,6" form:"introduction" json:"introduction" query:"introduction"`
}
...
type UploadVideoRequest struct {
	Token        string `thrift:"token,1" header:"Authorization" json:"token"`
	VideoFile    []byte `thrift:"videoFile,2" form:"videoFile" json:"videoFile" query:"videoFile"`
	VideoFormat  string `thrift:"video_format,3" form:"video_format" json:"video_format" query:"video_format"`
	CoverFile    []byte `thrift:"coverFile,4" form:"coverFile" json:"coverFile" query:"coverFile"`
	CoverFormat  string `thrift:"cover_format,5" form:"cover_format" json:"cover_format" query:"cover_format"`
